<?php get_header(); ?>
	...
	<div class="c-index-visual">
		<div class="c-index-visual__top">
			<div class="c-index-visual__top--slider">
				<div class="c-index-visual__top--item add-animation"><img src="<?php echo get_template_directory_uri(); ?>/common/img/top/pic_mv01.png" alt="マンションリノベーション" class="__img"></div>
				<div class="c-index-visual__top--item"><img src="<?php echo get_template_directory_uri(); ?>/common/img/top/pic_mv02.png" alt="マンションリノベーション" class="__img"></div>
				<div class="c-index-visual__top--item"><img src="<?php echo get_template_directory_uri(); ?>/common/img/top/pic_mv03.png" alt="マンションリノベーション" class="__img"></div>
			</div>
			<div class="c-index-visual__top--catch">
				<img src="<?php echo get_template_directory_uri(); ?>/common/img/top/pic_copy.svg" alt="セキスイハイムが考えるマンションリノベーション" class="__img">
			</div>
		</div>
		<div class="c-index-visual__bottom">
			<div class="c-index-visual__bottom--slider">
				<div class="c-index-visual__bottom--item"><img src="<?php echo get_template_directory_uri(); ?>/common/img/top/pic_mvsub01.png" alt="リノベーション事例" class="__img"></div>
				<div class="c-index-visual__bottom--item"><img src="<?php echo get_template_directory_uri(); ?>/common/img/top/pic_mvsub02.png" alt="リノベーション事例" class="__img"></div>
				<div class="c-index-visual__bottom--item"><img src="<?php echo get_template_directory_uri(); ?>/common/img/top/pic_mvsub03.png" alt="リノベーション事例" class="__img"></div>
				<div class="c-index-visual__bottom--item"><img src="<?php echo get_template_directory_uri(); ?>/common/img/top/pic_mvsub04.png" alt="リノベーション事例" class="__img"></div>
				<div class="c-index-visual__bottom--item"><img src="<?php echo get_template_directory_uri(); ?>/common/img/top/pic_mvsub05.png" alt="リノベーション事例" class="__img"></div>
				<div class="c-index-visual__bottom--item"><img src="<?php echo get_template_directory_uri(); ?>/common/img/top/pic_mvsub06.png" alt="リノベーション事例" class="__img"></div>
			</div>
		</div>
	</div>
	...
	<section class="c-index-quality __bg">
		...
		<div class="c-index-quality__inner">
			...
			<div class="c-index-quality__list is-fade">
				...
				<div class="c-index-quality__list--item">
					<span class="__icon"><img src="<?php echo get_template_directory_uri(); ?>/common/img/top/ico_about02.svg" alt="空間デザイン力" class="__img"></span>
					<span class="__sub">空間<br>デザイン力</span>
				</div>
				<div class="c-index-quality__list--item">
					<span class="__icon"><img src="<?php echo get_template_directory_uri(); ?>/common/img/top/ico_about03.svg" alt="長期サポート" class="__img"></span>
					<span class="__sub">長期<br>サポート</span>
				</div>
			</div>
		</div>
	...
	<section class="c-index-renovation">
		...
		<div class="c-index-renovation__sample">
			<img src="<?php echo get_template_directory_uri(); ?>/common/img/top/renovation.gif" alt="リノベーション例" class="__img">
		</div>
	</section>
				...
				<div class="c-works-list__item is-fade">
					<a class="c-works-list__link" href="<?php the_permalink(); ?>">
						<div class="c-works-list__img">
							...
							<?php else : ?>
								<img src="<?php echo get_template_directory_uri(); ?>/common/img/common/pic_dummy.png" alt="<?php the_title(); ?>" class="__img">
							<?php endif; ?>
